...
{ path:'dashboard', component : DashboardComponent, canActivate: [RoleGaurd], data:{roles: ['admin', 'user']}, children:[{path:'addmovie',component:AddmovieComponent, canActivate: [RoleGaurd], data:{roles: 'admin'}},
                                                              ...
                                                              {path: 'movie/:id' , component: MoviedetailComponent,  canActivate: [RoleGaurd], data:{roles: ['admin', 'user']}, children: [{path: 'add-review', component: AddReviewComponent,  canActivate: [RoleGaurd], data:{roles: ['admin', 'user']}}]},                                                             
